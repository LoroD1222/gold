...
const safariTrip = defineType({
  ...
  groups: [
    ...
    {name: 'features', title: 'Tour Features & Transportation'},
  ...
  fields: [
    ...
    defineField({
      name: 'tourStart',
      title: 'Best time',
      description: 'For example, “June–October”.',
      type: 'string',
      group: 'hero',
    }),
    defineField({
    ...
    defineField({
      name: 'tourStyle',
      title: 'Tour style',
      description: 'The overall comfort and service level of the safari.',
      type: 'string',
      group: 'features',
      options: {
        list: ['Budget', 'Mid-range', 'Luxury', 'Budget Camping'],
        layout: 'radio',
      },
    }),
    defineField({
      ...
      title: 'Accommodation',
      description: 'The types of accommodation used during the tour.',
      type: 'array',
      group: 'features',
      of: [defineArrayMember({type: 'string', options: {list: ['Lodge', 'Hotel', 'Tented Camp', 'Camping', 'Cottage', 'Mountain Hut', 'Other']}})],
      options: {layout: 'tags'},
      validation: (rule) => rule.unique(),
    }),
    defineField({
      name: 'tourType',
      title: 'Tour type',
      description: 'Shows whether the safari is private or shared with other travelers.',
      type: 'string',
      group: 'features',
      options: {list: ['Private', 'Shared'], layout: 'radio'},
    }),
    defineField({
      name: 'maxGroupSize',
    ...
    defineField({
      name: 'departureType',
      title: 'Departure',
      description: 'Shows how flexible the safari departure date is.',
      type: 'string',
      group: 'features',
      options: {list: ['Any Day', 'Fixed Departure'], layout: 'radio'},
    }),
    defineField({
      name: 'customization',
      title: 'Customization',
      description: 'Shows whether the itinerary, accommodation or destinations can be changed.',
      type: 'string',
      group: 'features',
      options: {list: ['Fully Customizable', 'Minor Changes Allowed', 'Not Customizable'], layout: 'radio'},
    }),
    defineField({
      name: 'soloTravelers',
      title: 'Solo travelers',
      description: 'Indicates whether the tour can be booked by a solo traveler.',
      type: 'string',
      group: 'features',
      options: {list: ['Allowed', 'Not Allowed'], layout: 'radio'},
    }),
    defineField({
      name: 'minimumAge',
      title: 'Minimum age',
      description: 'The minimum age required to participate in the tour. Use 0 for all ages.',
      type: 'number',
      group: 'features',
      validation: (rule) => rule.integer().min(0),
    }),
    defineField({
      name: 'activities',
      title: 'Activities',
      description: 'The wildlife, adventure and leisure activities included in the itinerary.',
      type: 'array',
      group: 'features',
      of: [defineArrayMember({type: 'string', options: {list: ['Game Drives', 'Night Game Drives', 'Walking Safari', 'Nature Walks / Hikes', 'Boat Safari / Boat Trip', 'Beach Time', 'Other']}})],
      options: {layout: 'tags'},
      validation: (rule) => rule.unique(),
    }),
    defineField({
      name: 'gameDriveVehicles',
      title: 'Safari vehicle',
      description: 'The type of vehicle used for wildlife viewing and game drives.',
      type: 'array',
      group: 'features',
      of: [defineArrayMember({type: 'string', options: {list: ['Pop-up Roof 4x4', 'Pop-up Roof Minivan', 'Minivan', 'Other']}})],
      options: {layout: 'tags'},
      validation: (rule) => rule.unique(),
    }),
    defineField({
      ...
      description: 'The main transportation methods used between destinations.',
      type: 'array',
      group: 'features',
      of: [defineArrayMember({type: 'string', options: {list: ['4x4 Safari Vehicle', 'Minivan', 'Air Transfer', 'Boat Transfer', 'Other']}})],
      options: {layout: 'tags'},
      validation: (rule) => rule.unique(),
    }),
    defineField({
      ...
      description: 'Shows whether airport pickup and drop-off are included.',
      type: 'string',
      group: 'features',
      options: {list: ['Included', 'Available at Extra Cost', 'Not Included'], layout: 'radio'},
    }),
            ...
            defineField({
              ...
              options: {
                list: [
                  ...
                  {title: 'Impala', value: 'antelope'},
                  {title: 'Spotted hyena', value: 'hyena'},
                  {title: 'Ostrich', value: 'ostrich'},
                  {title: 'Wildebeest', value: 'wildebeest'},
                  {title: 'Zebra', value: 'zebra'},
                  {title: 'Hippo', value: 'hippopotamus'},
                  {title: 'Buffalo', value: 'african-buffalo'},
                  {title: 'Rhino', value: 'rhinoceros'},
